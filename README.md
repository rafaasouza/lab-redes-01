![GitHub License](https://img.shields.io/github/license/rafaasouza/lab-redes-01)
...
| PC1 | Reserva DHCP | 192.168.102 | IP reservado pelo roteador |
...
- O roteador semrpre atribui o mesmo endereço IP a esses dispositivos.
